...
QWidget * RegMapDelegate::createEditor(QWidget *parent, const QStyleOptionViewItem &option, const QModelIndex &index)
{
        (void)option;
        (void)index;
        QLineEdit * lineEdit  = new QLineEdit(parent);
        QValidator *validator = new QRegularExpressionValidator(*m_regex,this);
        lineEdit->setValidator(validator);
        return(lineEdit);
}
void RegMapDelegate::paint(QPainter *painter, const QStyleOptionViewItem &option, const QModelIndex &index)
{
        painter->save();
