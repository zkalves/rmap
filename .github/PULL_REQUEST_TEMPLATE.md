## Description
Provide a concise summary of the changes introduced by this pull request. Reference any related issues (e.g. `Fixes #123`).

## Type of Change
- [ ] Bug fix (non-breaking change fixing an issue)
- [ ] New feature (non-breaking change adding functionality)
- [ ] Format handler / serializer update
- [ ] Code generator template enhancement
