...
2. **Visual Address Space Diagram**:
   ...
   - **Example File**: See [`examples/rmt/features/address_gap_example.rmt`](https://github.com/zkalves/rmap/blob/main/examples/rmt/features/address_gap_example.rmt) for a sample register map demonstrating unmapped address gaps.
