...
def main():
    print("[Python Harness] Testing address_gap_example Register Driver...")
    mem = {}
    def sim_read(addr):
    ...
    block = reg_map.Sparse_DeviceBlock(base_addr=0x0, read_fn=sim_read, write_fn=sim_write)
    ...
    print("[Python Harness] All address_gap_example driver tests PASSED!")
