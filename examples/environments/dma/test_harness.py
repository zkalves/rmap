...
def main():
    print("[Python Harness] Testing dma Register Driver...")
    mem = {}
    def sim_read(addr):
    ...
    block = reg_map.DMA_CONTROLLERBlock(base_addr=0x0, read_fn=sim_read, write_fn=sim_write)
    reg = getattr(block, 'dma_ctrl')
    ...
    print("[Python Harness] All dma driver tests PASSED!")
