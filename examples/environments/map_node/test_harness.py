...
def main():
    print("[Python Harness] Testing map_node Register Driver...")
    mem = {}
    def sim_read(addr):
    ...
    block = reg_map.BUS_ROUTERBlock(base_addr=0x0, read_fn=sim_read, write_fn=sim_write)
    reg = getattr(block, 'router_ctrl')
    ...
    print("[Python Harness] All map_node driver tests PASSED!")
